...
This sample module contains one small method that filters contigs.
    ...
    def run_kbeilsmithTestST(self, ctx, params):
        """
        ...
        #BEGIN run_kbeilsmithTestST

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_kbeilsmithTestST function. Params=' + pformat(params))
        ...
        #END run_kbeilsmithTestST

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_kbeilsmithTestST return value ' +
